...
library DeftLib {
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IDeftPair(
    ...
    function getAmountsOut(
        ...
        require(path.length >= 2, "DeftLib: INVALID_PATH");
    ...
    {
        require(tokenA != tokenB, "DeftLib: IDENTICAL_ADDRESSES");
        (token0, token1) = tokenA < tokenB
            ? (tokenA, tokenB)
            : (tokenB, tokenA);
        require(token0 != address(0), "DeftLib: ZERO_ADDRESS");
    }
    ...
    function quote(
        ...
        require(amountA > 0, "DeftLib: INSUFFICIENT_AMOUNT");
        require(
